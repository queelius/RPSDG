...
simple_rules = [
    ...
    Rule("Rewrite -x as -1 * x",
         Variable("x"),
         BinaryOp("*", Number(-1), Variable("x"))),
    Rule("Rewrite x + x as 2*x",
         BinaryOp("+", Variable("x"), Variable("x")),
         BinaryOp("*", Number(2), Variable("x"))),
    Rule("Rewrite a*a as a^2",
         BinaryOp("*", BinaryOp("*", Variable("n"), Variable("a")), Variable("a")),
         BinaryOp("*", Variable("n"), BinaryOp("^", Number(2), Variable("a")))),
